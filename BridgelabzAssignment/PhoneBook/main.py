...
book = Book(r"C:\Users\HP\PycharmProjects\BridgelabzAssignment\PhoneBook\Book.json")
while True:
...
with open(r"C:\Users\HP\PycharmProjects\BridgelabzAssignment\PhoneBook\Book.json", 'w') as out_file:
